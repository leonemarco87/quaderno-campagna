  ...
  return (
    <div className="fade-in space-y-5">
      <PageHeader icon="🌿" title="Registro Trattamenti Fitosanitari"
        ...
        actions={<><ExportBar data={rows} columns={columns} title="Registro Trattamenti Fitosanitari" filename="trattamenti" /><button className="btn-primary" onClick={openNew}><Plus size={16}/>Nuovo trattamento</button></>}
      />
